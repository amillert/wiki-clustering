...
- Exercise 4
    Classification process can be found under: `prediction/run.py`, visualization is located in: `utils/visualization.py`. The classifier model is declared in `prediction/model/classifier.py`.
